...
namespace ThuisMedicijnDispenser
{
    ...
    class FysiekeMedicijnDispenser
    {
        ...
        public async Task VoegDoseringstijdToe(int compartimentNr, int uur, int minuut)
        {
            if (compartimentNr >= 0 && compartimentNr < compartimenten.Count && compartimenten[compartimentNr] != null)
            {
                ...
                await SchedulerService.AddJob<DispenseJob>($"MedicijnJob{compartimentNr}", "MedicijnGroup", 5);
